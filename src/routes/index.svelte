...
<style lang="postcss">
	section {
		@apply container mx-auto min-h-screen p-8;
	}

	button {
		@apply rounded-md px-3 py-2 font-bold text-white ring-1 ring-white ring-opacity-20 transition-colors hover:bg-white hover:bg-opacity-50;
	}
</style>
